...
import Styles from "./AdminRole.module.scss";
...
const AdminsRole = () => {
  ...
  return (
    <>
      <Row className={(`card-title mb-0`, clsx(Styles.container))}>
        <Col sm="12">
          <Card>
            {/* className={(`card-title mb-0`,clsx(Styles.image))} */}
            <Card.Header className="d-flex justify-content-between flex-wrap">
              <div className="header-title">
                <h2 className={(`card-title mb-0`, clsx(Styles.h2))}>
                  Role & Permission
                </h2>
              </div>
              <div>
